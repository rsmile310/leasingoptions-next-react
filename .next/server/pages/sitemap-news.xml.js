...
module.exports = __webpack_require__("K+y4");
...
const getServerSideProps = async ({
  ...
  const items = await Object(business_logic_sitemapService__WEBPACK_IMPORTED_MODULE_0__[/* GetSitemapNewsPages */ "h"])(false);
  res.setHeader('Content-Type', 'text/xml; charset=utf-8');
  res.write(SitemapNewsPages(items));
  res.end();
};

const SitemapNewsPages = items => {
...
/* harmony default export */ __webpack_exports__["default"] = (SitemapNewsPages);
