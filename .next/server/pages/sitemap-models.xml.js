...
module.exports = __webpack_require__("dxEI");
...
const getServerSideProps = async ({
  ...
  const pages = await Object(business_logic_sitemapService__WEBPACK_IMPORTED_MODULE_0__[/* GetModelPages */ "d"])();
  res.setHeader('Content-Type', 'text/xml; charset=utf-8');
  res.write(SitemapModelsPages(pages));
  res.end();
};

const SitemapModelsPages = items => {
...
/* harmony default export */ __webpack_exports__["default"] = (SitemapModelsPages);
