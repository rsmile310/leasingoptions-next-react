...
export const getProps = async (context) => {
    ...
    let modelPreviews = (await GetVehicleModelPreviews(vehiclesFilter, { pageSize: 9999, pageIndex: 1 }, undefined, fetchHeaders)).data;
    ...
    if (isNullOrWhiteSpace(title)) {
        title = `${(vehicleType === VehicleTypes.Commercial ? "Vans" : "Cars")} over £${originalValue}`;
    }
