...
const SoleStepSix: React.FC<ProposalStepProps> = (props) => {

    const handleGATracking = () => logLabelEvent('prop_form_tracking_soletrader', 'Click', 'bank-address-completed');
...
export default connect(mapStateToProps)(SoleStepSix);