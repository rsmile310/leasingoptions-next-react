...
const SoleStepTwo: React.FC<ProposalStepProps> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_soletrader', 'Click', 'business-details-completed');
...
export default connect(mapStateToProps)(SoleStepTwo)