...
const PartnerStepSix: React.FC<ProposalStepProps> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_partnership', 'Click', 'bank-details-completed');
...
export default connect(mapStateToProps)(PartnerStepSix);