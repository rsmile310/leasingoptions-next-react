...
const PartnerStepOne: React.FC<ProposalStepProps> = (props) => {
    
    const { register, handleSubmit, errors } = useForm();
    const handleGATracking = () => logLabelEvent('prop_form_tracking_partnership', 'Click', 'start-application');
    ...
    return (
        <div className="w-100 bg-white p-3 p-md-5">
            ...
            <ul>
                ...
                <li className="d-flex align-items-center mb-2"><FontAwesomeIcon width="25" height="25" icon={faCheck} className="circled-check" /> Partner Details</li>
...
export default connect(mapStateToProps)(PartnerStepOne)