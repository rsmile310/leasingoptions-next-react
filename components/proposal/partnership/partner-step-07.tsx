...
const PartnerStepSeven: React.FC<ProposalStepProps> = (props) => {

    const handleGATracking = () => logLabelEvent('prop_form_tracking_partnership', 'Click', 'bank-address-completed');
...
export default connect(mapStateToProps)(PartnerStepSeven);