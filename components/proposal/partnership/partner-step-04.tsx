...
const PartnerStepFour: React.FC<ProposalStepProps> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_partnership', 'Click', 'partner-1-details-completed');
...
export default connect(mapStateToProps)(PartnerStepFour)