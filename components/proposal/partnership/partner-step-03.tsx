...
const PartnerStepThree: React.FC<ProposalStepProps> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_partnership', 'Click', 'contact-and-address-completed');
...
export default connect(mapStateToProps)(PartnerStepThree)