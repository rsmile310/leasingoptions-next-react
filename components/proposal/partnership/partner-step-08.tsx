...
const PartnerStepEight: React.FC<ProposalStepProps> = (props) => {
    
    const handleGATracking = () => logLabelEvent('prop_form_tracking_partnership', 'Click', 'completed-application');
...
export default connect(mapStateToProps)(PartnerStepEight);