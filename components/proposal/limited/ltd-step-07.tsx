...
const LimitedStepSeven: React.FC<ProposalStepProps> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_ltd', 'Click', 'completed-application');
...
export default connect(mapStateToProps)(LimitedStepSeven);