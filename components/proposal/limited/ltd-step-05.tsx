...
const LimitedStepFive: React.FC<ProposalStepProps> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_ltd', 'Click', 'account-details-completed');
...
export default connect(mapStateToProps)(LimitedStepFive);