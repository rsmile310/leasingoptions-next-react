...
import DirectorsList from '../business/directors-list';
...
const LimitedStepFour: React.FC<ProposalStepProps> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_ltd', 'Click', 'directors-list-completed');
        ...
        <div className="w-100 bg-white p-3 p-md-5">
            <FormContext {...methods} >
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <DirectorsList formData={formData} />
...
export default connect(mapStateToProps)(LimitedStepFour)