...
const LimitedStepTwo: React.FC<ProposalStepProps> = (props) => {
    
    const handleGATracking = () => logLabelEvent('prop_form_tracking_ltd', 'Click', 'business-details-completed');
        ...
        <div className="w-100 bg-white p-3 p-md-5">
            <FormContext {...methods}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <BusinessDetails formData={formData} includeCompanyNumber={true} />
...
export default connect(mapStateToProps)(LimitedStepTwo)