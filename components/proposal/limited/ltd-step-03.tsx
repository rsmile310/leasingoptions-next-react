...
const LimitedStepThree: React.FC<ProposalStepProps> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_ltd', 'Click', 'contact-and-address-completed');
...
export default connect(mapStateToProps)(LimitedStepThree)