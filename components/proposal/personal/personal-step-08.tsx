...
const PersonalStepEight: React.FC<ProposalStepProps & {
    showAccountName: boolean,
    showAccountNumer: boolean
    showSortCodeLookup: boolean,

}> = (props) => {

    const formData = props.formData[props.stepNumber];
    const handleGATracking = () => logLabelEvent('prop_form_tracking_personal', 'Click', 'bank-details-completed');
        ...
        <div className="w-100 bg-white p-3 p-md-5">
            ...
            <FormContext {...methods}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <AccountDetails showSortCodeLookup={props.showSortCodeLookup} showAccountNumer={props.showAccountNumer} showAccountName={props.showAccountName} formData={formData} />
...
export default connect(mapStateToProps)(PersonalStepEight);