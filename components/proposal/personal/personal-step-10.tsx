...
const PersonalStepTen: React.FC<ProposalStepProps> = (props) => {

    const handleGATracking = () => logLabelEvent('prop_form_tracking_personal', 'Click', 'completed-application');
...
export default connect(mapStateToProps)(PersonalStepTen);