...
const PersonalStepNine: React.FC<ProposalStepProps> = (props) => {
    
    const handleGATracking = () => logLabelEvent('prop_form_tracking_personal', 'Click', 'bank-address-completed');
    ...
    const { register, setValue, handleSubmit, errors } = methods;
...
export default connect(mapStateToProps)(PersonalStepNine);