...
const CarModelInternalPage = ({ leasingDealType, vehicleType, title, description, modelImage, modelGallery, modelReview, vehicleFilter, make, model, topRecommended, alternativeModels }) => {
    return (
...
CarModelInternalPage.layout = MainLayout;

export default connect(mapStateToProps)(CarModelInternalPage);