...
const VanModelInternalPage = ({ vehicleType, title, description, modelImage, modelGallery, modelReview, vehicleFilter, make, model, topRecommended, alternativeModels }) => {
    return (
...
VanModelInternalPage.layout = MainLayout;

export default VanModelInternalPage;