      ...
      <div id="content-container" className="main">
        <article className="content-wrapper order-and-quotation-explanation">
          <div className="container">
            <h1 className="h1">Explanation of your order</h1>
            <div className="article-content">
              <p>
                Please be confident before proceeding that you fully understand
                each element of your order, a brief overview of each section is
                detailed below:
              </p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  package payable to the funder. This figure is indicative and
                  will be confirmed on your finance agreement.
                </li>
                <li>
                ...
                <li>
                  ...
                  Each mile travelled in excess of the annual mileage will
                ...
                <li>
                  <span className="title">Order Inclusions</span>
...
ExplanationOfYourOrder.layout = MainLayout;

export default ExplanationOfYourOrder;
