import {  GetSitemapNewsPages } from "business-logic/sitemapService";
...
export const getServerSideProps: GetServerSideProps = async ({ res, req }) => {
    ...
    const items:Array<SitemapPageItem> = await GetSitemapNewsPages(false);
...
export default SitemapNewsPages;
