    ...
    return (
        <>
            <MetaHead>
                ...
                <meta name="description" content="Proposal Sole Trader" />
                <meta name="keywords" content="Proposal Sole Trader" />
            </MetaHead>
            <section className="container-fluid py-3 py-md-5 bg-light-grey">
                <div className="container">
                    <div className="row">
                        <div className="col-24">
                            <DynamicProposalWizardComponent proposalType={ProposalTypes.BusinessSole} />
                        </div>
                    </div>
                </div>
            </section>
